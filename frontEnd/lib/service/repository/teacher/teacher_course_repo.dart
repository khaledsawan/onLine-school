...
class TeacherCourseRepo extends GetxService {
  late final ApiClient apiClient;

  TeacherCourseRepo({required this.apiClient});

  Future<Response> GetProductList() async {
    return await apiClient.getData(AppConstants.TEACHER_COURSES_URL);
  }
  Future<Response> getSearchTeacherList(NameModel nameModel) async {
    return await apiClient.postData(AppConstants.TEACHER_COURSE_SEARCH_URL,nameModel.toJson());
  }
