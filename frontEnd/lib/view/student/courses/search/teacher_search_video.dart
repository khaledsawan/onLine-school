...
class StudentSearchVideo extends SearchDelegate {
  late int i;
  StudentSearchVideo(this.i);
    ...
    return InkWell(
        onTap: () {
          Get.find<StudentVideoController>()
              ...
              .then((value) => Get.toNamed(AppRoutes.studentvideopage));
        },
        child: Container(
  ...
  Widget buildResults(BuildContext context) {
    return FutureBuilder<List<SearchData>>(
        future: Get.find<StudentVideoController>()
