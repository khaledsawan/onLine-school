...
class AdminTeacherSearchPage extends SearchDelegate {
  design(BuildContext context, Teachers data) {
    return InkWell(
        onTap: () {
          Get.find<AdminTeacherController>()
              .viewTeacher(data.id!)
  ...
  Widget buildResults(BuildContext context) {
    return FutureBuilder<List<Teachers>>(
        future:
            Get.find<AdminTeacherController>().getCourseSearch(query: query),
